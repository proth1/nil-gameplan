  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-nil-dark-400 mt-1">Manage your NIL alert subscriptions</p>
      </div>
      ...
      <div className="card p-8 text-center">
        ...
        <h3 className="text-lg font-medium text-white mb-2">Alert Management</h3>
        <p className="text-nil-dark-400 mb-4">
          Create and manage custom alerts for NIL content, deals, and regulatory changes.
        </p>
