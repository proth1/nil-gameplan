  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-nil-dark-400 mt-1">Manage NIL content sources and harvesting configuration</p>
      </div>
      ...
      <div className="card p-8 text-center">
        ...
        <h3 className="text-lg font-medium text-white mb-2">Source Management</h3>
        <p className="text-nil-dark-400 mb-4">
          Configure and manage content sources for the NIL harvesting system.
        </p>
